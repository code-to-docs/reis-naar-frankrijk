...
const SEMANTIC_RULES: SemanticRule[] = [
  {
    ...
    requiredTokens: ['--color-error', '--color-danger', '--btn-danger', '--text-error'],
    forbiddenTokens: ['--color-primary', '--color-success'],
  },
  {
    ...
    requiredTokens: ['--color-success', '--color-primary', '--btn-primary', '--text-success'],
    forbiddenTokens: ['--color-error'],
  },
  {
    name: 'Waarschuwingen',
    contextPatterns: [
